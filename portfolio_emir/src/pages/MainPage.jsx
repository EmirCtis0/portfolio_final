                    ...
                    siteDataIsLoading ?
                        ...
                        <section className="w-full relative grid lg:grid-cols-2 grid-cols-1">
                            <div className="flex flex-col justify-center items-center lg:items-start lg:order-1 order-2 animate-fadeInTop">
                                ...
                                21 yaşında bir yazılım geliştirici olarak, frontend, backend ve genel yazılım geliştirme alanlarında kendimi sürekli geliştiriyorum. Kullanıcı dostu ve estetik arayüzler oluşturma tutkum, backend tarafında da güçlü, güvenilir ve ölçeklenebilir çözümler üretme becerimle birleşiyor. Kod dünyasının her katmanında yenilikçi ve işlevsel çözümler sunarak dijital dünyada iz bırakmaya kararlıyım.
                                </span>
                            </div>
